...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        String FfName = reader.readLine();
        Cat catFf = new Cat(FfName);

        String MmName = reader.readLine();
        Cat catMm = new Cat(MmName);

        String fatherName = reader.readLine();
        Cat catFather = new Cat(fatherName, catFf, null);

        String motherName = reader.readLine();
        Cat catMother = new Cat(motherName, null, catMm);
